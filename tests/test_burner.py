...
def test_list_rules():
    ...
    with pytest.raises(ValueError):
        rb.list_rules(diameter=8, usage=["forward"])
    rules = rb.list_rules(diameter=8, usage=["FORWARD", "BOTH"])
    assert rules == []

@pytest.mark.parametrize(
    "smarts,inchi,expected_inchi",
    [
        (reaction_smarts, substrate_inchi, ['InChI=1S/C3H7O6P/c1-2(3(4)5)9-10(6,7)8/h2H,1H3,(H,4,5)(H2,6,7,8)', 'InChI=1S/C10H15N5O11P2/c11-10-13-7-4(8(18)14-10)12-2-15(7)9-6(17)5(16)3(25-9)1-24-28(22,23)26-27(19,20)21/h2-3,5-6,9,16-17H,1H2,(H,22,23)(H2,19,20,21)(H3,11,13,14,18)'])
    ]
)
